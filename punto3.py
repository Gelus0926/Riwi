#Diseñar un algoritmo que pida por teclado tres números; si el primero es negatico, debe imprimir el producto de los tres y si no lo es, imprimirá la suma
